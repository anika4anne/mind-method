          ...
          >
            ...
            >
              ...
              <div className="relative z-10 rounded-xl border-2 border-cyan-400/30 bg-white/5 p-2">
                <div className="calendar-wrapper relative overflow-hidden rounded-lg">
                  <iframe
                    src="https://calendar.google.com/calendar/embed?height=800&wkst=1&ctz=America%2FNew_York&showPrint=0&src=Y19jbGFzc3Jvb20wYTI3NGQ4YkBncm91cC5jYWxlbmRhci5nb29nbGUuY29t&color=%23007b83"
                    width="1000"
                    height="800"
                    frameBorder="0"
                    scrolling="no"
